...
#### JavaScript
- لتطوير واجهات تفاعلية، خصوصًا في التطبيقات مثل POS ولوحات التحكم
- إطار عمل خاص

#### HTML & CSS
- لتصميم وتنسيق واجهات المستخدم
- تصميم متجاوب (Responsive Design)

#### XML
- لتحديد النماذج (Views) داخل النظام
- صفحات HTML من البيانات

### 2. Backend Technologies

#### Python & Django
- إطار العمل الأساسي للنظام
- Django REST Framework للـ API

### 3. التكاملات (Integrations)

#### REST API / GraphQL
- للتكامل مع أنظمة خارجية مثل Shopify، PayPal

#### JSON
- لتبادل البيانات بين التطبيقات

#### Webhooks
- للتفاعل مع خدمات خارجية بشكل لحظي
