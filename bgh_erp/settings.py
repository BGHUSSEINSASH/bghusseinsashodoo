"""
Django settings for bgh_erp project.
...
SECRET_KEY = 'django-insecure-o!tu!(fezcgxr(a-^6!py5zf7_2m_q&@#p(hcl+ib%$9205(03'
...
WSGI_APPLICATION = 'bgh_erp.wsgi.application'
